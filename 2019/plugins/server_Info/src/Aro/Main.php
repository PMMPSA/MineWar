	...
	public function onCommand(CommandSender $sender, Command $cmd, $label, array $args){
		switch($cmd->getName()){
			...
			case "info":
			   ...
			   $sender->sendMessage("§7∘ §aserver thành lập ngày §b**/**/**** §avà cũng là ngày mở cửa chính thức");
			   ...
			   $sender->sendMessage("§7∘ §6Op Prison – Cuộc chiến nhà tù");
			...
			case "thongbao":
			   ...
			   $sender->sendMessage("§b-> Liên hệ tại §eBit.do/*** §bđể đăng ký công việc");
			   return true;
			case "allsv":
